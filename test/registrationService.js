...
describe('RegistrationService', () => {
  it('creates a new registration', async () => {
    ...
    const verificationService = mock(emailVerificationService)
    ...
    verificationService.expects('verify').withArgs('a@b.c').once()

    await new RegistrationService(registrationRepository, trenitalia, emailVerificationService, stubLog).addRegistration('a@b.c', '4640', 'S00458')
  ...
  it('respond with an error when train not found', async () => {
    ...
    try {
      let retu = await new RegistrationService(registrationRepository, trenitalia, emailVerificationService, stubLog, stubLog).addRegistration('a@b.c', 'not_found', 'not_found')
