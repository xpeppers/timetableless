...
exports.RegistrationService = function RegistrationService(repository, trenitalia, verificationService, log = console.log, logError = console.log) {
  ...
  this.addRegistration = async (recipient, train, station) => {
    try {
      ...
      verificationService.verify(recipient)
